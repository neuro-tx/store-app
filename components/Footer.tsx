    ...
    <footer className="py-16 md:py-20 border-t bg-neutral-900 border-neutral-700 text-white">
      <div className="mx-auto max-w-5xl px-6 space-y-6">
        ...
        <div className="flex justify-center gap-6 text-muted-foreground">
          ...
          {/* Facebook */}
          <Link
            href="https://www.facebook.com/share/17CnRHqeok/"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="text-center max-w-md mx-auto">
          <p className="text-muted-foreground leading-relaxed">
            ...
            <span className="font-medium text-white block mt-2">
              مول وسط البلد — مدينة النوبارية الجديدة — محافظة البحيرة
            </span>
          </p>
        </div>

        {/* Copyright */}
        <span className="text-sm block text-center text-muted-foreground">
